...
namespace project
{
    public class DB
    {
        ...
        private static string _stepPC = "218-5";
        ...
        public void GetData()
        {
            ...
            Program.mainForm.moneyLabel.Text = $"₸ {Convert.ToString(LoginForm.userDataTable.Rows[0].Field<Int64>("u_currentMoney"))}";
            Program.mainForm.increasedMoneyLabel.Text = $"↑ {Convert.ToString(LoginForm.userDataTable.Rows[0].Field<Int64>("u_increasedMoney"))}";
            Program.mainForm.decreasedMoneyLabel.Text = $"↓ {Convert.ToString(LoginForm.userDataTable.Rows[0].Field<Int64>("u_decreasedMoney"))}";
        ...
        public void EditDataOut(int sum)
        {
            ...
            if (sum > Convert.ToInt32(dt.Rows[0].Field<Int64>("u_currentMoney")))
            {
